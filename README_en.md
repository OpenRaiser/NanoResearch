...
<div align="center" style="max-width: 720px; margin: 0 auto;">
  <video src="imgs/demo_cli_tui_theme.mp4" controls muted playsinline loop width="100%" style="max-width: 100%; border-radius: 8px;">
    <a href="imgs/demo_cli_tui_theme.mp4">Download / play CLI demo video</a>
  </video>
  <br /><sub><i>TUI layout, color theme switching, and improved on-screen structure</i></sub>
</div>
...
### Example outputs
=======
### CLI: Plain Log Output vs TUI Mode

The CLI supports **classic streaming logs (non-TUI)** and a **full-screen TUI**—switch based on your workflow.

<div align="center" style="max-width: 720px; margin: 0 auto;">
  <p><b>Plain output (non-TUI)</b></p>
  <img src="imgs/demo_no_tui_mode.png" width="100%" alt="NanoResearch CLI plain log output" style="max-width: 100%; border-radius: 8px;" />
  <p><sub><b>Non-TUI</b>: classic terminal log stream—easy to pipe and script</sub></p>
</div>
<div align="center" style="max-width: 720px; margin: 0 auto; margin-top: 1.5em;">
  <p><b>TUI mode</b></p>
  <img src="imgs/demo_tui_mode.png" width="100%" alt="NanoResearch CLI TUI mode" style="max-width: 100%; border-radius: 8px;" />
  <p><sub><b>TUI</b>: structured panels and status regions for interactive monitoring</sub></p>
</div>

### Example Outputs
>>>>>>> Refresh README (CN/EN) and add showcase assets
